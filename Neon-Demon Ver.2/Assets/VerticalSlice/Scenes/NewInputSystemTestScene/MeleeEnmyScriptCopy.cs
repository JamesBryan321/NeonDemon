...
public class MeleeEnmyScriptCopy : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //chanceToSpawnPickup = Random.Range(0, 3);
        chanceToSpawnPickup = 1;
    ...
    void Update()
    {
        ...
        if(EnemyHealth <= 0)
        {
            ...
            Dead = true;
            DeathSFX.Play();
            transform.GetComponent<MeleeEnmyScriptCopy>().enabled = false;
            return;
